...
export default function Workshops() {
  return (
    <section className="bg-surface text-on-surface p-4">
      <header>
        <h4
          className="text-lg bg-clip-text text-transparent bg-gradient-to-r from-green-200 to-green-400
          inline-block
          "
        >
          Workshops
        ...
        <p className="pt-4">
          Work directly with GitHub experts on EcoSystems, Professional
          Services, and/or Security topics during these two-hour, hands-on
          Workshops.
        </p>
      </header>
      <div className="mt-4">
